...
import jantanivesh.shared.generated.resources.add_goal
...
fun YourGoalsScreen(
    ...
    Column(
        ...
        NextButtonFooter(
            ...
            value = if (state.goals.isNotEmpty()){ "Invest Now/ " + stringResource(Res.string.invest_now) } else "Add Goal/ " + stringResource(Res.string.add_goal),
            onClick = {
                if (state.goals.isEmpty()){
